...
if __name__ == '__main__':
    ...
    j = np.loadtxt('./data/5-26/GMm16alpha4.txt')
    e = np.loadtxt('./data/5-26/FSm16alpha4.txt')
    b = np.loadtxt('./data/5-26/Gm16alpha3.txt')
    k = np.loadtxt('./data/5-26/GMm16alpha3.txt')
    d = np.loadtxt('./data/5-26/FSm16alpha3.txt')
    c = np.loadtxt('./data/5-26/Gm16alpha2.txt')
    l = np.loadtxt('./data/5-26/GMm16alpha2.txt')
    f = np.loadtxt('./data/5-26/FSm16alpha2.txt')
    g = np.loadtxt('./data/5-26/Gm16alpha1-5.txt')
    m = np.loadtxt('./data/5-26/GMm16alpha1-5.txt')
    h = np.loadtxt('./data/5-26/FSm16alpha1-5.txt')
    length1 = len(a)
    ax1 = []
    ay1 = []
    ay2 = []
    ...
    # plt.show()
    plt.savefig("/Users/weichenchen/Desktop/实时系统/实验结果/NEWm16alpha3.png", format="PNG")
    plt.show()
    ...
    plt.grid(True)
    plt.legend()
    plt.suptitle("task sets scheduling analysis (implicit-deadline, 16 processors, alpha=2)", fontsize=22)
    # plt.show()
    plt.savefig("/Users/weichenchen/Desktop/实时系统/实验结果/NEWm16alpha2.png", format="PNG")
    plt.show()
    ...
    plt.grid(True)
    plt.legend()
    plt.suptitle("task sets scheduling analysis (implicit-deadline, 16 processors, alpha=1.5)", fontsize=22)
    # plt.show()
