...
if __name__ == '__main__':
    a = np.loadtxt('./data/5-26/Gm16HLR2.txt')
    b = np.loadtxt('./data/5-26/GMm16HLR2.txt')
    c = np.loadtxt('./data/5-26/FSm16HLR2.txt')
    d = np.loadtxt('./data/5-26/Gm16HLR3.txt')
    e = np.loadtxt('./data/5-26/GMm16HLR3.txt')
    f = np.loadtxt('./data/5-26/FSm16HLR3.txt')
    g = np.loadtxt('./data/5-26/Gm16HLR4.txt')
    h = np.loadtxt('./data/5-26/GMm16HLR4.txt')
    j = np.loadtxt('./data/5-26/FSm16HLR4.txt')
    k = np.loadtxt('./data/5-26/Gm16HLR5.txt')
    l = np.loadtxt('./data/5-26/GMm16HLR5.txt')
    m = np.loadtxt('./data/5-26/FSm16HLR5.txt')
    length1 = len(a)
    ax1 = []
    ay1 = []
    ay2 = []
    ...
    plt.grid(True)
    plt.legend()
    # plt.suptitle(u"任务集调度分析（隐式截止期限，16核心，重任务占比=1/2）", fontsize=22)
    # plt.suptitle("task sets scheduling analysis (implicit-deadline, 16 processors, heavy_rate=1/2)", fontsize=22)
    # plt.show()
    plt.subplots_adjust(wspace=0.3, hspace=0.3)
    plt.savefig("/Users/weichenchen/Desktop/实时系统/实验结果/NEWm16heavy_rate2.png", format="PNG")
    plt.show()
    ...
    plt.grid(True)
    plt.legend()
    # plt.suptitle(u"任务集调度分析（隐式截止期限，16核心，重任务占比=1/3）", fontsize=22)
    # plt.suptitle("task sets scheduling analysis (implicit-deadline, 16 processors, heavy_rate=1/3)", fontsize=22)
    # plt.show()
    plt.subplots_adjust(wspace=0.3, hspace=0.3)
    plt.savefig("/Users/weichenchen/Desktop/实时系统/实验结果/NEWm16heavy_rate3.png", format="PNG")
    plt.show()
    ...
    plt.grid(True)
    plt.legend()
    # plt.suptitle(u"任务集调度分析（隐式截止期限，16核心，重任务占比=1/4）", fontsize=22)
    # plt.suptitle("task sets scheduling analysis (implicit-deadline, 16 processors, heavy_rate=1/4)", fontsize=22)
    # plt.show()
    plt.subplots_adjust(wspace=0.3, hspace=0.3)
    plt.savefig("/Users/weichenchen/Desktop/实时系统/实验结果/NEWm16heavy_rate4.png", format="PNG")
    plt.show()
    ...
    plt.grid(True)
    plt.legend()
    # plt.suptitle(u"任务集调度分析（隐式截止期限，16核心，重任务占比=1/5）", fontsize=22)
    # plt.suptitle("task sets scheduling analysis (implicit-deadline, 16 processors, heavy_rate=1/5)", fontsize=22)
    # plt.show()
    plt.subplots_adjust(wspace=0.3, hspace=0.3)
    plt.savefig("/Users/weichenchen/Desktop/实时系统/实验结果/NEWm16heavy_rate5.png", format="PNG")
    plt.show()
